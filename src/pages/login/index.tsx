...
export default function Index() {
  ...
  return (
      <div className="flex w-full md:h-[675px] bg-slate-50 justify-between">
        <div className="hidden bg-neutral-500 md:block  w-[790px] relative">
          ...
          />
          <div className="w-[400px] flex flex-col items-center absolute top-[300px] left-[200px]">
            <h1 className="font-bold text-[64px] h-[100px] leading-[100px] tracking-[0.043m] font-poppins">{t("login.newHere")}</h1>
            <p className="font-poppins text-[20px] font-semibold leading[19px] text-blue-neutral tracking-[0.003em]">{t("login.createAccount")}</p>
          </div>
          <Image
